...
class LocationWidget extends StatefulWidget {
  ...
  const LocationWidget({Key? key, required this.aptNumberController, this.onLocationSelected}) : super(key: key);
...
class _LocationWidgetState extends State<LocationWidget> {
  ...
  void initState() {
    ...
    // Initialize with an empty list to avoid null errors
