                ...
                return GestureDetector(
                  onTap: (){
                    switch(notification.type) {
                      case 'exit_requests' :
                        Get.toNamed(RouteName.exitRequestScreen, arguments: notification.exit);
                      case 'attendance_requests' :
                        Get.toNamed(RouteName.attendanceRequestScreen, arguments: notification.attendance);
                      case 'late_requests' :
                        Get.toNamed(RouteName.lateRequestScreen, arguments: notification.lateEarly);
                      case 'early_requests' :
                        Get.toNamed(RouteName.earlyRequestScreen, arguments: notification.lateEarly);
                      case 'leave_requests' :
                        Get.toNamed(RouteName.shiftLeaveRequestScreen, arguments: notification.leave);
                    }
                  },
                  child: Column(
                    children: [
