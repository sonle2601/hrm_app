...
import 'package:employee_manager/view/account/information/text_row_widget.dart';
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextRowWidget(title: 'Ngày gia nhập', info: FormatUtils.timeAgo(employee.startTime.toString())),
                      ],
                    ),
                  ),
                  Container(
